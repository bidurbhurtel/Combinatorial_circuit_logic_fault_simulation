...
int ReadVec(FILE *fvec, PATTERN *vec)
{
    ...
    char str[Mpi];
    //fvec = fopen("c17.vec", "r+");
       
    int i = 0;
    while ((fgets(str, sizeof(str), fvec)) != NULL) {
...
//}//end of readvec
/****************************************************************************************************************************/
// Routine to read fault file
int ReadFau(FILE *ffau, FAULT *fau)
{
    char temp[2][Mft];    
    char str[Mft];   
    //ffau = fopen("c17.faults", "r+");
      
    int i = 0;
    while ((fgets(str, Mft, ffau)) != NULL) {
        ...
        fau[i].Snod = atoi(temp[0]);
        fau[i].Sval = atoi(temp[1]);
        printf("%d\n", fau[i].Snod);
        printf("%d\n", fau[i].Sval);
        i++;
